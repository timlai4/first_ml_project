...
training_examples = preprocess_features(suicide_dataframe.head(20000)) #20k
training_examples.describe()

training_targets = preprocess_targets(suicide_dataframe.head(20000))
training_targets.describe()

validation_examples = preprocess_features(suicide_dataframe.tail(7000)) #7k
...
def train_nn_regression_model(
  ...
  predict_validation_input_fn = lambda: my_input_fn(validation_examples, 
                                                    validation_targets["suicides/100k"], 
                                                    num_epochs=1, 
                                                    shuffle=False)
...
_ = train_nn_regression_model(
    ...
    steps=6000,
    batch_size=70,
    hidden_units=[300, 300, 150, 150, 150, 100],
